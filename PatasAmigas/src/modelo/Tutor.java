...
public class Tutor extends Pessoa {
    ...
    public Tutor(int animais_custodia, String historico_adocao, String status, String nome, LocalDate nascimento, String sexo, long cpf, String endereco, long telefone, String email, String senha) {
